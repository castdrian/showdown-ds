...
Iron Valiant's true back-facing fallback sprite is fetched from the [PokeAPI sprites repository](https://github.com/PokeAPI/sprites) when Showdown does not publish an animated back asset for that species.
