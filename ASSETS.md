...
Iron Valiant's true back-facing fallback uses the [PokeAPI sprites repository](https://github.com/PokeAPI/sprites) when Showdown does not publish a usable animated back asset.
