...
class BattleSceneViewContractTest {
    ...
    fun keepsPlayerAndOpponentSpriteOrientationDistinct() {
        ...
        assertTrue(source.contains("playerActiveSprites[combatant.slot] ?: playerPlaceholder"))
        assertTrue(source.contains("opponentActiveSprites[combatant.slot] ?: opponentPlaceholder"))
        ...
        assertTrue(source.contains("session.opponentPokemon"))
        assertTrue(source.contains("session.playerPokemon"))
        assertTrue(source.contains("playerSprite ?: playerPlaceholder"))
        assertTrue(source.contains("opponentSprite ?: opponentPlaceholder"))
        assertTrue(!source.contains("pokemonOverride"))
        assertTrue(!source.contains("spriteOverride"))
