...
object BattlePlaybackTiming {
    const val EVENT_PAUSE_MILLIS = 1_450L
    ...
    private const val FAINT_PAUSE_MILLIS = 1_800L
    private const val SWITCH_PAUSE_MILLIS = 1_500L
    private const val TURN_PAUSE_MILLIS = 1_000L
    private const val END_OF_BATTLE_PAUSE_MILLIS = 2_200L
}
