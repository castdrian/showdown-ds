    ...
    fun entries(currentVersion: String) = listOf(
        ShowdownChangelogEntry(
            ...
            listOf(
                ...
                "Front sprites now resolve indexed PKParaíso giant animation and HOME artwork before smaller animated or Showdown fallbacks.",
                "Front-facing Pokémon now show high-resolution HOME artwork while indexed HD animation is still loading, so temporary fallback frames no longer look like decoys.",
