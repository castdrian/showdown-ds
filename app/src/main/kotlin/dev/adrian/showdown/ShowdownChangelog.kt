    ...
    fun entries(currentVersion: String) = listOf(
        ShowdownChangelogEntry(
            ...
            listOf(
                ...
                "Battle-log misses, immunities, failed moves, field activations, combined moves, and Z-Power messages now match Showdown's official wording.",
                ...
                "The team editor now rejects malformed numeric values and unsupported genders instead of silently changing them.",
