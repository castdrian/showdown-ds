                        ...
                        function installAudioHooks() {
                            ...
                            Battle.prototype.runMinor = function (args) {
                                ...
                                if (!kwArgs.silent) {
                                    ...
                                    if (args[0] === '-status' && args[2] === 'psn') announcerResultCue = 'poison';
                                    if (args[0] === '-status' && args[2] === 'tox') announcerResultCue = 'toxic_poison';
                                    if (args[0] === '-status' && args[2] === 'brn') announcerResultCue = 'burn';
                                    if (args[0] === '-status' && args[2] === 'par') announcerResultCue = 'paralysis';
                                    if (args[0] === '-status' && args[2] === 'slp') announcerResultCue = 'sleep';
                                    if (args[0] === '-status' && args[2] === 'frz') announcerResultCue = 'freeze';
                                    if (args[0] === '-start' && args[2] === 'confusion') announcerResultCue = 'confusion';
                                    if (args[0] === '-boost' && magnitude !== 0) announcerResultCue = magnitude > 0 ? 'stat_boost' : 'stat_drop';
                                    if (args[0] === '-unboost' && magnitude !== 0) announcerResultCue = magnitude > 0 ? 'stat_drop' : 'stat_boost';
                                    if (args[0] === '-setboost' && magnitude !== 0) announcerResultCue = magnitude > 0 ? 'stat_boost' : 'stat_drop';
                                    if (args[0] === '-clearpositiveboost' || args[0] === '-clearboost' || args[0] === '-clearallboost') announcerResultCue = 'stat_drop';
                                    if (args[0] === '-clearnegativeboost' || args[0] === '-restoreboost') announcerResultCue = 'stat_boost';
