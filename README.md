...
Includes live Showdown battles, readable two-screen playback, HD-first battle and team-preview sprites with shiny front and rear variants, a searchable team library with four move slots per Pokémon, shared team-link imports, replays, rooms, chat, and account tools.
